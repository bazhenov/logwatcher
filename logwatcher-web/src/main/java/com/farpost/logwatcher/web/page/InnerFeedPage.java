...
@Component
public class InnerFeedPage implements ViewNameAwarePage, InitializingBean {
	...
	public InnerFeedPage(HttpServletRequest request, Date date, String applicationId, Severity severity, String sortOrder) {
