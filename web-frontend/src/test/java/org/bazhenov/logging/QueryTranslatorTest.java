...
public class QueryTranslatorTest {
	...
	public void dateCriteria() throws InvalidQueryException {
		...
		assertThat(translate("occured: " + today()), equalTo(expectedMatcher));
	}
	...
	public void dateIntervalCriteria() throws InvalidQueryException {
		...
		assertThat(translate("occured: " + date+" / "+date.minusDay(1)), equalTo(expectedMatcher));
	}
	...
	public void dateHumanReadableIntervalCriteria() throws InvalidQueryException {
		...
		assertThat(translate("occured: last 2 days"), equalTo(expectedMatcher));
	}
